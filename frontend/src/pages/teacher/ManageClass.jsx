...
import {FiPlus, FiTrash2, FiArrowRight, FiUsers, FiLoader} from 'react-icons/fi';
        ...
        <TeacherLayout>
            ...
            <div className="card mb-6">
                ...
                <div className="flex gap-3">
                    ...
                    />
                    <button className="btn-primary whitespace-nowrap" onClick={handleCreate} disabled={mutationLoading}>
                        <FiPlus size={16}/>
            ...
            {listLoading ? (
                <div className="flex justify-center py-20">
                    <FiLoader size={22} className="animate-spin text-slate-300"/>
                </div>
            ) : classes.length === 0 ? (
                            ...
                            <div key={c.classId}
                                ...
                                <div className="p-5 flex flex-col flex-1">
                                    ...
                                    <div className="flex items-start gap-3 mb-5">
                                        <div
                                            className={`w-11 h-11 rounded-xl bg-gradient-to-br ${s.avatar} flex items-center justify-center text-white font-extrabold text-lg shrink-0 select-none shadow-sm`}>
                                            {initial}
                                        </div>
