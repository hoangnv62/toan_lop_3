...
- A plan exists (`.claude/features/[feature-name]/todo.md`)
...
Update `.claude/features/[feature-name]/todo.md`:
```markdown
...
- Working, tested code
- Updated `.claude/features/[feature-name]/todo.md` with completed items
