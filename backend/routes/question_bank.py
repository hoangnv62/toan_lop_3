...
question_bank_bp.add_url_rule("/api/question-bank/import-excel",         view_func=require_auth(ctrl.import_questions),  methods=["POST"])
question_bank_bp.add_url_rule("/api/question-bank/sample-excel",         view_func=require_auth(ctrl.download_sample),   methods=["GET"])
