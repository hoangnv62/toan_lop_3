...
| # | Use Case | Mô tả |
|---|---|---|
| UC04 | Xem thống kê tổng quan | Số lớp, học sinh,  bài tập, điểm trung bình |
...
| UC11 | Xem kết quả học sinh | Danh sách điểm từng  bài tập của học sinh |
...
| # | Use Case | Mô tả |
|---|---|---|
| UC15 | Tạo / Sửa / Xóa  bài tập | CRUD  bài tập trong bài học |
| UC16 | Sao chép  bài tập | Clone toàn bộ câu hỏi + đáp án |
...
| UC19 | Giao  bài tập cho lớp | Chọn lớp, đặt deadline và thời gian làm bài |
| UC20 | Hủy giao  bài tập | Gỡ  bài tập khỏi lớp |
| UC21 | Xem thống kê  bài tập | Phân phối điểm, tỉ lệ đúng từng câu |
| UC22 | Xuất kết quả  bài tập (Excel) | Tải file Excel toàn bộ kết quả |
...
| UC28 | Dùng câu hỏi từ ngân hàng | Chọn câu hỏi từ ngân hàng vào  bài tập |
...
| UC32 | Xem danh sách  bài tập | Danh sách  bài tập được giao, có deadline |
| UC33 | Làm  bài tập | Trả lời câu hỏi trắc nghiệm, giới hạn thời gian |
| UC34 | Xem kết quả  bài tập | Điểm, số câu đúng, đáp án chi tiết |
